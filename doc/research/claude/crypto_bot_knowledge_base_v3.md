# Crypto Trading Bot — Knowledge Base v3

> องค์ความรู้แบบแยกหมวดหมู่ พร้อม design decisions และ recommended stack
> อัปเดตครั้งที่ 3 — เพิ่ม Validation Methodology ครบชุด, Drift Detection & Action Tiers, Framework Spikes & Decision Matrix จาก Codex v2 research
...
17. [Design Decisions Summary](#14-design-decisions-summary)
18. [Version Roadmap](#15-version-roadmap)
19. [กฎสำคัญที่ต้องจำ](#16-กฎสำคัญที่ต้องจำ)
...
*Knowledge base v3 — อัปเดตเพิ่ม Validation Methodology ครบชุด (DSR, PBO, Survivorship Bias), Drift Detection & Action Tiers (4 types), Framework Selection & Spikes (Freqtrade/VectorBT/NautilusTrader/Custom) จาก Codex v2 research*
